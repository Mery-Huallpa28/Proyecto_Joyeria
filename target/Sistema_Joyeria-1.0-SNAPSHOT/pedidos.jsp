    ...
    <body class="categories-page">
        ...
        <section class="main-content">
            <div class="container">
                <h1>PEDIDOS</h1>
                <br>
                <a href="PedidoController?action=add" class="btn btn-primary btn-sm"><i class="fas fa-plus-circle"></i>Nuevo</a>
                ...
                <div class="table-container">
                    <table border="1">
                        ...
                        <tr>
                            ...
                            <th style="color: white; font-weight: bold; font-size: 20px;">Entregado</th>
                            <th style="color: white; font-weight: bold; font-size: 20px;">Pagado</th>
                            <th style="color: white; font-weight: bold; font-size: 20px;">Direccion</th>
                            <th style="color: white; font-weight: bold; font-size: 20px;">Cliente</th>
                        ...
                        <c:forEach var="item" items="${pedidos}">
                            <tr>
                                ...
                                <td style="color: black; font-weight: bold; font-size: 20px;">${item.entregado}</td>
                                <td style="color: black; font-weight: bold; font-size: 20px;">${item.pagado}</td>
                                <td style="color: black; font-weight: bold; font-size: 20px;">${item.direccion}</td>
                                <td style="color: black; font-weight: bold; font-size: 20px;">${item.cliente}</td>
                                <td style="color: black; font-weight: bold; font-size: 20px;">${item.producto}</td>
                                <td><a href="PedidoController?action=edit&id=${item.id}"><i class="fas fa-edit"></i></a></td>
                                <td><a href="PedidoController?action=delete&id=${item.id}" onclick="return(confirm('¿Está seguro?'))"><i class="fas fa-trash-alt"></i></a></td>
                            </tr>
                        </c:forEach>
