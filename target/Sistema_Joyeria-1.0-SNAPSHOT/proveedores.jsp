    ...
    <body class="categories-page">
        ...
        <section class="main-content">
            <div class="container">
                <h1>Proveedores</h1>
                <br>
                <a href="ProveedorController?action=add" class="btn btn-primary btn-sm"><i class="fas fa-plus-circle"></i>Nuevo</a>
                    ...
                    <table border="1">
                        ...
                        <c:forEach var="item" items="${proveedores}">
                            <tr>
                                ...
                                <td style="color: black; font-weight: bold; font-size: 20px;"><a href="ProveedorController?action=edit&id=${item.id}"><i class="fas fa-edit"></i></a></td>
                                <td style="color: black; font-weight: bold; font-size: 20px;"><a href="ProveedorController?action=delete&id=${item.id}" onclick="return(confirm('¿Está seguro?'))"><i class="fas fa-trash-alt"></i></a></td>
                            </tr>
                        </c:forEach>
