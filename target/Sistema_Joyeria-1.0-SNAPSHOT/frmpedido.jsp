        ...
        <div class="container">
            ...
            <form action="PedidoController" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="fecha" value="${pedido.fecha}" placeholder="Escriba la Fecha">
                </div>

                <div class="form-group">
                    <label for="" class="form-label">Precio</label>
                    <input type="text" class="form-control" name="precio" value="${pedido.precio}" placeholder="Escriba el Precio">
                </div>

                <div class="form-group">
                    <label for="" class="form-label">Entregado</label>
                    <input type="text" class="form-control" name="entregado" value="${pedido.entregado}">
                </div>

                <div class="form-group">
                    <label for="" class="form-label">Pagado</label>
                    <input type="text" class="form-control" name="pagado" value="${pedido.pagado}">
                </div>


                <div class="form-group">
                    <label for="" class="form-label">Direccion</label>
                    <input type="text" class="form-control" name="direccion" value="${pedido.direccion}" placeholder="Escriba su direccion">
                </div>
                    ...
                    <select name="cliente_id" class="form-control">
                        ...
                        <c:forEach var="item" items="${lista_clientes}">
                            <option value="${item.id}"
                                    <c:if test="${pedido.cliente_id == item.id}"> 
                                        selected
                                    </c:if> 
                                    >${item.nombres}</option>
                        </c:forEach>
                ...
                <div class="form-group">
                    ...
                    <select name="producto_id" class="form-control">
                        ...
                        <c:forEach var="item" items="${lista_productos}">
                            <option value="${item.id}"
                                    <c:if test="${pedido.producto_id == item.id}"> 
                                        selected
                                    </c:if> 
                                    >${item.nombre}</option>
                        </c:forEach>
