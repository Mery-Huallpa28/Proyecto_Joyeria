...
<body>
    ...
    <section>
        <div>
            <h1>Categorías</h1>
            <br>
            <a href="CategoriaController?action=add" class="btn btn-primary btn-sm"><i class="fas fa-plus-circle"></i> Nuevo</a>
                ...
                <table>
                    ...
                    <c:forEach var="item" items="${categorias}">
                        <tr>
                            ...
                            <td><a href="CategoriaController?action=edit&id=${item.id}"><i class="fas fa-edit"></i></a></td>
                            <td><a href="CategoriaController?action=delete&id=${item.id}" onclick="return confirm('¿Está seguro?')"><i class="fas fa-trash-alt"></i></a></td>
                        </tr>
                    </c:forEach>
                </table>
            </div>
